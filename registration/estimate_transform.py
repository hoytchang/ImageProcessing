...
img0 = io.imread('IbeamStype.jpg')
img1 = io.imread('steel-beam.jpg')
...
io.imsave('0warped.jpg',img0_warped)
io.imsave('1warped.jpg',img1_warped)
io.imsave('registered.jpg',registered)